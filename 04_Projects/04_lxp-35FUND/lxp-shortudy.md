...
3차 프로젝트에서 우리는 LXP의 정체성을 재정의하고, 숏폼 플레이어를 중심으로 한 MVP를 완성했다.
4차 프로젝트는 그 기반 위에 실제 사용자 경험을 완성하는 기능 확장의 단계였다.

숏츠 등록/수정/삭제, 마이페이지-내가 만든 숏츠 목록, 댓글과 좋아요, 플레이리스트 등
...
숏폼 비디오 파일은 평균 10~50MB로, 기본 제한을 크게 초과했다.
