...
그러나 가장 큰 도전은 기술이 아니라 개념이었다. 프론트엔드와 백엔드, 서로 다른 관점을 가진 팀원들이 LXP의 본질을 어디에 둘 것인가를 다시 정의해야 했다. 서로 다른 배경과 관점을 가진 팀원들이 하나의 비전을 만들어가는 과정. 이것이 <b>우리가 3차 프로젝트에서 마주한 진짜 과제</b>였다.
...
- <b>기술적 성장</b> : Next.js 서버/클라이언트 컴포넌트 이해, 타입 안정성의 가치
